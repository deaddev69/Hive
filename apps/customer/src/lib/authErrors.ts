...
const MESSAGES: Record<string, string> = {
  ...
  // Fires when a provider is switched on in the app but not enabled in the Firebase console.
  "auth/operation-not-allowed": "This sign-in method isn't available right now. Please try another option.",
