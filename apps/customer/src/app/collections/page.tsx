...
export const metadata = {
  title: "Collections — Hive by TailorBee",
  description:
    "Browse curated boutique fashion collections for every occasion — weddings, festivals, workwear, and more. Delivered same-day in Kochi.",
};
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-base text-hive-text-muted max-w-lg leading-relaxed">
                Eight hand-picked collections from verified local boutiques.
