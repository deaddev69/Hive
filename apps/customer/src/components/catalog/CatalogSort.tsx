    ...
    <div className={cn("w-full md:w-auto", className)}>
      ...
      <div className="w-full">
        <button
          ...
          className="w-full inline-flex items-center justify-between gap-2 px-4 py-2 border border-slate-200 bg-white rounded-lg text-xs font-semibold text-slate-800 shadow-none hover:bg-slate-50 transition-colors cursor-pointer"
        >
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center text-slate-500 w-4 h-4">
