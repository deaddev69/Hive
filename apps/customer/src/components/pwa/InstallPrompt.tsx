    ...
    return (
      <div className="hive-install-modal-overlay fixed inset-0 z-[100] flex flex-col items-center justify-end bg-black/40 backdrop-blur-sm sm:p-6 transition-opacity">
        <div className="relative w-full md:max-w-md bg-[#fdfbf7] rounded-t-3xl sm:rounded-3xl shadow-2xl animate-in slide-in-from-bottom duration-300 flex flex-col p-6 md:p-8 border border-stone-200/40 text-center items-center overflow-hidden">
          ...
          <div className="my-8 w-16 h-16 bg-[#a47a24]/10 rounded-2xl flex items-center justify-center text-[#a47a24] shrink-0 animate-bounce">
          ...
          <p className="text-stone-600 text-sm max-w-xs mx-auto leading-relaxed mb-8">
          ...
          <button 
            ...
            className="w-full bg-[#a47a24] hover:bg-[#8f6a1e] text-white py-4 rounded-xl font-bold transition active:scale-[0.98] focus:outline-none"
          >
            Got it
          </button>
        </div>
  ...
  return (
    <>
      ...
      <div className="hive-install-modal-overlay fixed inset-0 z-[100] flex flex-col items-center justify-end bg-black/40 backdrop-blur-sm sm:p-6 transition-opacity">
        ...
        <div className="relative w-full md:max-w-md bg-[#fdfbf7] rounded-t-[32px] sm:rounded-[32px] shadow-2xl animate-in slide-in-from-bottom duration-350 flex flex-col p-6 md:p-8 border border-stone-200/40 text-center items-center overflow-hidden">
          ...
          <button 
            onClick={handleDismiss} 
            className="absolute top-4 right-4 p-2 bg-stone-200/50 hover:bg-stone-200/80 rounded-full text-slate-600 transition focus:outline-none z-10"
            aria-label="Close"
          >
          ...
          <div className="mb-2 mt-4 animate-in fade-in zoom-in-95 duration-500 relative z-10">
            <HiveLogo noLink size="md" className="scale-105" />
            <div className="w-12 h-[1px] bg-[#a47a24]/60 mx-auto mt-3" />
          </div>

          {/* Editorial Headline */}
          <h2 className="text-3xl md:text-4xl font-serif text-slate-900 tracking-tight leading-[1.15] mt-6 relative z-10">
            Fashion, made<br />
            <span className="text-[#a47a24] italic font-normal">effortless.</span>
          </h2>
          
          {/* Supporting Statement */}
          <p className="text-stone-500 text-sm mt-3 max-w-[280px] mx-auto leading-relaxed relative z-10">
          ...
          <button 
            ...
            className="mt-8 w-full max-w-[320px] bg-[#a47a24] hover:bg-[#8f6a1e] text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2.5 shadow-lg transition active:scale-[0.98] focus:outline-none relative z-10"
          >
          ...
          {/* Metadata Captions */}
          <div className="flex items-center justify-center gap-1.5 mt-3.5 text-[11px] text-stone-500 font-medium relative z-10">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-stone-400">
          ...
          <div className="grid grid-cols-3 divide-x divide-stone-200/60 mt-10 w-full max-w-sm relative z-10">
            
            {/* Benefit 1 */}
            <div className="px-2 text-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#a47a24" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="mx-auto mb-2 text-[#a47a24]">
                <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>
              </svg>
              <h3 className="text-xs font-bold text-slate-900 leading-tight">Opens instantly</h3>
              <p className="text-[10px] text-stone-500 leading-normal mt-1 max-w-[90px] mx-auto">Faster than the browser.</p>
            </div>
            ...
            <div className="px-2 text-center">
              ...
              <h3 className="text-xs font-bold text-slate-900 leading-tight">Live tracking</h3>
              <p className="text-[10px] text-stone-500 leading-normal mt-1 max-w-[90px] mx-auto">Track every order in real time.</p>
            </div>
            ...
            <div className="px-2 text-center">
              ...
              <h3 className="text-xs font-bold text-slate-900 leading-tight">Seamless checkout</h3>
              <p className="text-[10px] text-stone-500 leading-normal mt-1 max-w-[90px] mx-auto">One tap to shop your favourites.</p>
            </div>
          ...
          <button 
            onClick={handleDismiss}
            className="mt-8 text-stone-400 hover:text-stone-700 text-sm font-semibold tracking-wide underline decoration-stone-300 hover:decoration-stone-600 underline-offset-4 transition focus:outline-none relative z-10"
          >
            Not now
          </button>
