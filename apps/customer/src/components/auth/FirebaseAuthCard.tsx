        ...
        <form onSubmit={handleSendOtp} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative flex items-center">
              <div className="absolute left-3.5 flex items-center gap-1.5 text-xs font-bold text-slate-500 dark:text-neutral-400 border-r border-slate-200 dark:border-neutral-800 pr-2.5">
                <span>+91</span>
              </div>
              <input
                type="tel"
                ...
                className="w-full h-11 pl-16 pr-4 rounded-xl border border-slate-300 dark:border-neutral-800 focus:ring-2 focus:ring-hive-gold/45 focus:border-hive-gold text-xs font-medium bg-white dark:bg-neutral-900 transition-all outline-none"
                required
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="text-[11px] font-bold text-hive-amber dark:text-hive-gold hover:underline cursor-pointer"
              >
            ...
            <input
              ...
              placeholder="123456"
              maxLength={6}
              className="w-full h-12 text-center tracking-[0.4em] text-base font-bold rounded-xl border border-slate-300 dark:border-neutral-800 focus:ring-2 focus:ring-hive-gold/45 focus:border-hive-gold bg-white dark:bg-neutral-900 transition-all outline-none"
              required
              autoFocus
            />
          </div>
